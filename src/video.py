...
class Video():
    def __init__(self, file: str, window_length: float = 6, split_at: float = 25 * 60):
        self.file = file
        ...
        self._split(window_length, split_at)

    def _split(self, window_length: float, split_at: float):
        ...
        print(f'dividing {self.file} to trn {self.trn_from_time}:{self.trn_till_time} and val {self.val_from_time}:{self.val_till_time}')
